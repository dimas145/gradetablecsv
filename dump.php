...
require_once($CFG->dirroot . '/grade/export/gradetablecsv/grade_export_gradetablecsv.php');
...
require_capability('gradeexport/gradetablecsv:publish', $context);
...
$export = new grade_export_gradetablecsv($course, $groupid, $formdata);
$export->print_grades();
